...
$("form").submit(function(e) {
  ...
  var phone=$("input[name='phone']").val();
   ...
   $(".data-table tbody").append("<tr data-name='"+name+"' data-email='"+email+"' data-phone='"+phone+"'><td>"+name+"</td><td>"+email+"</td><td><button class='btn btn-danger btn-lg btn-delete mr-3' type='button'>Delete</button><button class='btn btn-info btn-lg btn-edit' type='button'>Edit</button></td><td>"+phone+"</td></tr>");
