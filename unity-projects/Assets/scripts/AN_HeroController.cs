...
public class AN_HeroController : MonoBehaviour
{
    ...
    {
        if (col.gameObject.name.StartsWith("car_1"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_2"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_3"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_4"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_5"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_6"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_7"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_8"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_9"))
        {
            SceneManager.LoadScene("GameOver");
        }
        if (col.gameObject.name.StartsWith("car_10"))
        {
            SceneManager.LoadScene("GameOver");
        }
